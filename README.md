...
**2.** Download the 'PushMeAlert' app on your IOS/Android Phone and register with your phone number. Go to settings opton and copy tokens- user & key. (refer to set-up instructions below)
